...
public class ComicModel implements Serializable {
    ...
    public ComicModel(String id_Comic, String id_Category, String title, String date, String img_comic, String name_Author, String name_Comic, int viewComic,ArrayList<ChapterModel> chapterModels,String desScription, boolean historyComic, boolean favouriteComic) {
